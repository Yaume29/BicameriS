...
class TraumaticMemory:
    ...
    def __init__(self, storage_path: str = "ZONE_RESERVEE/logs/traumatic_memory.json"):
    ...
    def add_failure(
        self, query: str, error: str, context: str = "", severity: str = "medium"
    ):
        """Enregistre un échec"""
        memory = {
    ...
    def get_context_injection(self, similar_memories: List[Dict]) -> str:
        ...
        injection = "\n[TOURNS MEMORY - Souvenirs d'échecs similaires]\n"
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "retry_counts": {
                ...
                "1-3": len(
                    [m for m in self._memories if 1 <= m.get("retry_count", 0) <= 3]
                ),
